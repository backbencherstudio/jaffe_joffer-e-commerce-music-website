...
export default function ExclusiveEdition() {
  ...
  return (
    <section className="bg-[image:var(--exclusive-pattern)] bg-cover   py-28">
      <div className=" container ">
        <SectionHeader
          heading="Exclusive Limited Edition Merch"
          subheading="Rep your favorite music bands with high-quality, stylish T-shirts! Perfect for concerts, casual wear, or as collectibles."
